...
import Logo from "@/data/footer-logo.svg";
  ...
  return (
    <footer className="footer">
      <div className="container mx-auto">
        ...
        <div className="footer-main flex justify-between items-center pt-20 pb-10 space-x-4 leading-4.5 border-b border-gray-200">
          
          <div className="footer-logo">
            <Link href="/" aria-label={siteMetadata.headerTitle}><Logo /></Link>
          </div>

          <div className="footer-contact flex gap-12">
        ...
        <div className="footer-bottom flex justify-between items-center flex-col pt-10 pb-10 space-x-4 leading-4.5x">
